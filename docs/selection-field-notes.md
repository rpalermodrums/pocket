...
- **A slot needs a trajectory.** Workshop now records positional energy targets for a gentle warm-up rise, a peak plateau and an after-hours taper. An explicit target overrides the preset. Track energy remains attributed annotation; no measurement is invented.
