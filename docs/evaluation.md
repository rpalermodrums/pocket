...
| Exact frame handoff | Five valid audio intervals across warped, natural and layered production regions went from Set Map to Track Map through MCP without changing either frame endpoint. Generated tests also cover tiny file-boundary overshoot, true out-of-range requests and stale handles. |
