...
The source bytes and detector evidence are immutable. The phrase span is attributed to the example's agent author, with uncertainty; it is not presented as detected or musically approved. No instrument, kick, note, harmony or acceptable added layer is inferred. This example exercises file and workflow behavior. It says nothing about accuracy or correction cost on a musician's own bass, drums or dense mix (milestone E8 in [what's supported](../../docs/midi-capabilities.md#roadmap-milestones)).
